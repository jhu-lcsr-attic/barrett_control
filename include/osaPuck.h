...
private:
  ...
  */
  static osaCANBusFrame::ID CANID( osaPuck::ID id );
  ...
  */
  static bool IsSetFrame( const osaCANBusFrame& canframe );
  ...
  */
  osaPuck::Errno PackProperty( osaCANBusFrame& canframe,
...
public:
  ...
  */
   ...
   */
  osaPuck::Errno UnpackCANFrame( const osaCANBusFrame& canframe, 
				 Barrett::ID& id, 
				 Barrett::Value& value );
